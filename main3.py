...
def main():
    ...
    if opts.ckpt is not None and os.path.isfile(opts.ckpt):
        ...
        model.classifier.classifier[-1] = nn.Conv2d(256, 3, kernel_size=(1, 1), stride=(1, 1))        
        ...
        #     params=[
        #         {
        #             "params": model.pretrained_model.backbone.parameters(),
        #             "lr": 0.01 * opts.lr,
        #         },
        #         {
        #             "params": model.pretrained_model.classifier.parameters(),
        #             "lr": 0.3 * opts.lr,
        #         },
