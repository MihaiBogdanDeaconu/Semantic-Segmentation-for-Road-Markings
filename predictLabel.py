...
from datasets import VOCSegmentation, Cityscapes, cityscapes, PaintedSymbols
...
def main():
    ...
    if opts.dataset.lower() == "voc":
        ...
        opts.num_classes = 3
        decode_fn = PaintedSymbols.decode_target
        ...
        for img_path in tqdm(image_files):
            ...
            if opts.save_val_results_to:
                ...
                pred.save(os.path.join(
                    "/shares/CC_v_Val_FV_Gen3_all/SemsegCrosswalkRestrictedArea/mihai/labels",
                    img_name + ".png"
                    ))
